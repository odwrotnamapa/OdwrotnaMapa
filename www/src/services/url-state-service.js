(function () {
  ...
  function setPlaceUrl({ label, lat, lon, osmType, osmId, replace = false }) {
    ...
    // Samo-odnosnikowy tag kanoniczny - jednoznacznie mowi Google
    // ktora wersja adresu jest "ta wlasciwa" dla tej strony. Bez tego
    // warianty parametrow (np. z/bez "osm=", albo stary/nowy adres po
    // poprawieniu wspolrzednej landmarku w bazie) moga zostac uznane
    // za duplikaty bez jasnego wskazania, ktora wersja ma wygrac.
